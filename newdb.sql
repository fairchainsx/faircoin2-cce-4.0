...
CREATE TABLE `block` (
  ...
  `payloadhash` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '0',
...
CREATE TABLE `chainParameter` (
  ...
  `transactionFee` decimal(17,8) NOT NULL DEFAULT '0',
  `dustThreshold` decimal(17,8) NOT NULL DEFAULT '0',
...
CREATE TABLE `orph_tx_in` (
  ...
  `asm` varchar(512) COLLATE utf8_bin NOT NULL DEFAULT '0',
  `hex` varchar(512) COLLATE utf8_bin NOT NULL DEFAULT '0',
